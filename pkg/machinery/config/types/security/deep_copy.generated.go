...
func (o *ImageVerificationConfigV1Alpha1) DeepCopy() *ImageVerificationConfigV1Alpha1 {
	...
	if o.ConfigRules != nil {
		...
		for i2 := range o.ConfigRules {
			if o.ConfigRules[i2].RuleVerifier != nil {
				cp.ConfigRules[i2].RuleVerifier = new(ImageVerifierV1Alpha1)
				*cp.ConfigRules[i2].RuleVerifier = *o.ConfigRules[i2].RuleVerifier
			}
		}
	}
	return &cp
